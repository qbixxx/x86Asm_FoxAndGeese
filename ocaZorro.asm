...
checkPosZorroDestino:
    ...
    cmp     qword[posCercanas+rbx],r12           ;r12 tiene el valor diff
   ...
   ; cmp     [diff],0
    ...
    idiv    r10
    mov     rbx,rax     ;resultado de diff/2 lo guardo en rbx
...
verificarEstadoJuego:
    ...
    mov     [checkNadieGana],0          ;si es 0 no gana nadie
